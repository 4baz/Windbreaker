...
namespace rage
{
	...
	public:
		...
		{
			uint32_t read;
			if (hbase::g_pointers->m_read_bitbuf_dword(this, &read, bits))
			{
				*integer = read;
				return true;
			}
		...
		{
			return hbase::g_pointers->m_read_bitbuf_dword(this, integer, bits);
		}
		...
		{
			return hbase::g_pointers->m_read_bitbuf_array(this, array, size, 0);
		}
